...
class WalkingEnemy(Enemy):
    def __init__(self, pos):
        Enemy.__init__(self, pos,
                       ...
                       {
                        "stand" : "SimpleEnemy/simpleEnemy-stand",
                        "walk" : "SimpleEnemy/simpleEnemy-walk",
                        "attack" : "SimpleEnemy/simpleEnemy-attack",
                        "die" : "SimpleEnemy/simpleEnemy-die",
                        "spawn" : "SimpleEnemy/simpleEnemy-spawn"
                       },
                       3.0,
                       7.0,
                       "walkingEnemy")
